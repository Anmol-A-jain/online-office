...
{
    pageurl.insert(PageName::home,"https://office.live.com/");
    pageurl.insert(PageName::word,"https://office.live.com/start/Word.aspx");
    pageurl.insert(PageName::excel,"https://office.live.com/start/Excel.aspx");
    pageurl.insert(PageName::powerPoint,"https://office.live.com/start/PowerPoint.aspx");
    pageurl.insert(PageName::oneDrive,"https://onedrive.live.com");
    pageurl.insert(PageName::outlook,"https://outlook.live.com");
}
...
void Office::setShadowColor()
{
    ...
    shadowcolor.insert(PageName::closeAll,QColor(255, 0, 0));
}
...
void Office::setinstallevent()
{
    ...
    ui->closeAll->installEventFilter(this);
...
bool Office::eventFilter(QObject *obj, QEvent *event)
{
    ...
    if(obj == static_cast<QObject*>(ui->closeAll))
    {
        setShadowEffect(ui->closeAll,shadowcolor[PageName::closeAll],event);
        return QWidget::eventFilter(obj,event);
    }
...
void Office::changePage(QString url)
{
    web->page()->setUrl(url);
}
...
void Office::onPageUrlChange()
{
    ...
    if(temp.contains(pageurl[PageName::word],Qt::CaseInsensitive) || temp.contains("app=Word",Qt::CaseInsensitive) || temp.contains("Cdocx",Qt::CaseInsensitive))
    {
    ...
    else if (temp.contains(pageurl[PageName::oneDrive],Qt::CaseInsensitive))
    {
        ui->title->setText("OneDrive");
        changeColor("white","black");
    }
    else if (temp.contains(pageurl[PageName::oneDrive],Qt::CaseInsensitive) && !temp.contains("https://onedrive.live.com/edit.aspx",Qt::CaseInsensitive))
    {
...
void Office::on_closeAll_clicked()
{

    delete web->page();
    delete history;
    history = new historyList;
    QWebEnginePage *temp = new QWebEnginePage;
    temp->setUrl(pageurl[PageName::home]);
    web->setPage(temp);
}
